# Generated by Django 4.2.16 on 2025-04-09 07:20
...
def extract_releaseLocation(apps, schema_editor):
    ...
    for movie in Movie.objects.all():
        ...
        if releaseDetailed:
            releaseLocation = releaseDetailed.get("releaseLocation").get("country")
            if releaseLocation:
                try:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0029_remove_movie_rating_remove_movie_releasedetailed'),
    ]
